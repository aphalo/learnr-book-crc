...
\usepackage[scale=0.15,text={\copyright\ 2024 Pedro J. Aphalo, PREPRINT}]{draftwatermark}
...
\title{Preprint:\\``Learn R: As a Language''\\[20mm]%
{\large\textup\textsf Book published by CRC Press, Boca Raton, 2024, in The R Series\\under ISBN: 978-1-032-51699-8 (pbk),\\ ISBN: 978-1-032-51843-5 (hbk)\\ and ISBN: 978-1-003-40418-7 (ebk).\\[20mm]%
Web site for the book at \texttt{https://www.learnr-book.info/}\\[5mm]%
Publisher's web site at \texttt{https://www.routledge.com/}.}}

\author{\copyright\ 2024 Pedro J. Aphalo}

\date{Helsinki, 2024. Printed \today}
