...
a[10:1] <- a
a
a[5:1] <- a[c(TRUE,FALSE)] # What?? It does work!
a
@
...
<<data-frames-8>>=
my_data_frame.df
my_data_frame.df[ , 1:5] <- my_data_frame.df[ , 5:1]
my_data_frame.df
@

<<data-frames-9>>=
my_data_frame.df
my_data_frame.df[c(1, 4, 10), ] <- my_data_frame.df[c(4, 10, 1), ]
my_data_frame.df
@
