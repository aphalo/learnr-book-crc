...
Temporarily disabled evaluation of \pkgname{ggtern} examples, as \pkgname{ggplo2} $>=$ 2.2.1.9000 breaks a core function of this package. This newer version of \pkgname{ggplo2} is required by the current development version of \pkgname{ggpmisc}.
