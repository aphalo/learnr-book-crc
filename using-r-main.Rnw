...
opts_fig_wide <- list(fig.width=9, fig.height=5, out.width='.9\\textwidth')
opts_fig_wide_square <- list(fig.width=9, fig.height=9, out.width='.9\\textwidth')
opts_fig_narrow <- list(fig.width=7, fig.height=5, out.width='.7\\textwidth')
