...
\begin{infobox}
\noindent
\textbf{Status as of 2017-01-21.} Wrote section on ggplot2 themes, and on using system- and Google fonts in ggpplots with the help of package \pkgname{showtext}.
