...
\end{alltt}
\begin{verbatim}
##  [1] 0.5975802 0.4876428 0.5756337 0.4718833 0.6007052 0.5440471 0.4693834
##  [8] 0.5740119 0.4845117 0.5760392
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
##  [1] 0.6059110 0.4823726 0.5873145 0.4843841 0.6216325 0.5581429 0.4691536
##  [8] 0.5824582 0.4997798 0.5954306
\end{verbatim}
\end{kframe}
\end{knitrout}
...
In the case of simple plots, based on data contained in a single data frame, the usual style is to code a plot as follows, as it emphasizes that \code{mtcars} contains the data shared by all layers in the plot and that a common mapping to aesthetics is used.
...
However, the grammar of graphics contemplates the possibility of data and mappings restricted to individual layers. In which case the those passed as arguments to \Rfunction{ggplot()} behave as defaults to those layers that inherit them, but can be overridden by arguments passed to individual layers. Making it possible to code the same plot as follows.
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-63-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-64-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-65-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-66-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-67-1} 
...
\includegraphics[width=.54\textwidth]{figure/pos-main-chunk-68-2} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-74-1} 
\includegraphics[width=.54\textwidth]{figure/pos-main-chunk-74-2} 
\includegraphics[width=.54\textwidth]{figure/pos-main-chunk-74-3} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-75-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-76-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-78-1} 
...
## [70] graphics_3.6.0      cellranger_1.1.0    gtable_0.3.0       
## [73] polyclip_1.10-0     assertthat_0.2.1    xfun_0.7           
## [76] broom_0.5.2         tidyverse_1.2.1     e1071_1.7-2        
## [79] filehash_2.4-2      class_7.3-15        survival_2.44-1.1  
## [82] viridisLite_0.3.0   beeswarm_0.2.3      units_0.6-3        
## [85] cluster_2.0.8       learnrbook_0.0.2
\end{verbatim}
\end{kframe}
\end{knitrout}
