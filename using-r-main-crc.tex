...
In clustering analysis the aim is to group observations into discrete groups with maximal internal homogeneity and maximum group to group differences. In the next example we use function \Rfunction{hclust()} from base \Rlang package \pkgname{stats}. We use, as above, the \code{eurodist} data which directly provides distances. In other cases a matrix of distances between pairs of observations needs to be first calculated with function \Rfunction{dist} which supports several methods.
...
\begin{explainbox}
In conclusion, \Rlang syntax for expressions is preserved when using the dot-pipe operator, with the only caveat that because of the low precedence of the \Roperator{\%.>\%} operator we need to ``protect'' bare expressions containing other operators by enclosing them in parentheses. \end{explainbox}
...
Some operations on \Rlang \code{data.frame} objects with \pkgname{tidyverse} packages will return \code{data.frame} objects while others will return tibbles---i.e.\ \code{tb} objects. Consequently it is safer to first convert into tibbles the data frames we will work with.
...
\begin{warningbox}
  Starting from version 1.0.0 of \pkgname{tidyr} \Rfunction{gather()} and \Rfunction{spread()} are deprecated and replaced by \Rfunction{pivot\_longer()} and \Rfunction{pivot\_wider()}. These new functions are not yet fully stable.
\end{warningbox}
...
\section{Further reading}
An\index{further reading} in-depth discussion of the \pkgname{tidyverse} is outside the scope of this book. Several books describe in detail the use of these packages. As several of them are under active development, recent editions of books such as \citebooktitle{Wickham2017} \autocite{Wickham2017} are the most useful.
...
## xxx.txt    0 FALSE  666 2019-09-29 13:26:22 2019-09-29 13:26:22
##                       atime exe
## xxx.txt 2019-09-29 13:26:22  no
\end{verbatim}
\begin{alltt}
...
The functions from \Rlang \pkgname{utils} package by default convert columns containg character strings into factors, as seen above. This default can be changed so that character strings remain as is.
...
## 1 2018-12-08T23:~ 0.03~ trkpt-2018-12-08~ T     3d    -34.912071 138.660595
## 2 2018-12-08T23:~ 0.08~ trkpt-2018-12-08~ T     3d    -34.912067 138.660543
## 3 2018-12-08T23:~ 0.01~ trkpt-2018-12-08~ T     3d    -34.912102 138.660554
## # ... with 196 more rows
\end{verbatim}
\end{kframe}
\end{knitrout}
...
There are two different comprehensive packages for importing data saved from other statistical programmes such as SAS, Statistica, SPSS, etc. The long time ``standard'' is package \pkgname{foreign} included in base \Rlang, and package \pkgname{haven} is newer contributed extension. In the case of files saved with old versions of statistical programs, functions from \pkgname{foreign} tend to be more robust than those from \pkgname{haven}.
...
\begin{explainbox}
  Many YoctoPuce modules have a built-in datalogger, and the stored data can also be downloaded as a \code{CSV} file through a physical or virtual hub.
\end{explainbox}
\index{importing data!physical devices|)}
...
##  [1] XML_3.98-1.20      pdftools_2.2       readODS_1.6.7     
##  [4] forcats_0.4.0      purrr_0.3.2        ggforce_0.3.1     
##  [7] ggbeeswarm_0.6.0   ggpmisc_0.3.1.9000 gginnards_0.0.2   
## [10] ggrepel_0.8.1      ggplot2_3.2.1      svglite_1.2.2     
## [13] knitr_1.25        
## 
## loaded via a namespace (and not attached):
##  [1] colorspace_1.4-1      ellipsis_0.3.0        class_7.3-15         
##  [4] rstudioapi_0.10       farver_1.1.0          hexbin_1.27.3        
##  [7] bit64_0.9-7           fansi_0.4.0           lubridate_1.7.4      
## [10] xml2_1.2.2            ncdf4_1.16.1          polyclip_1.10-0      
## [13] zeallot_0.1.0         polynom_1.4-0         jsonlite_1.6         
## [16] rematch_1.0.1         rJava_0.9-11          broom_0.5.2          
## [19] dbplyr_1.4.2          readr_1.3.1           compiler_3.6.1       
## [22] httr_1.4.1            backports_1.1.4       assertthat_0.2.1     
## [25] lazyeval_0.2.2        cli_1.1.0             tweenr_1.0.1         
## [28] gtable_0.3.0          glue_1.3.1            reshape2_1.4.3       
## [31] dplyr_0.8.3           Rcpp_1.0.2            tikzDevice_0.12.3    
## [34] cellranger_1.1.0      RNetCDF_1.9-1         vctrs_0.2.0          
## [37] filehash_2.4-2        nlme_3.1-140          xfun_0.9             
## [40] stringr_1.4.0         xlsxjars_0.6.1        rvest_0.3.4          
## [43] lifecycle_0.1.0       ncmeta_0.1.0          tidync_0.2.1         
## [46] xlsx_0.6.1            MASS_7.3-51.4         scales_1.0.0         
## [49] hms_0.5.1             tidyverse_1.2.1       RColorBrewer_1.1-2   
## [52] curl_4.2              memoise_1.1.0         gridExtra_2.3        
## [55] gdtools_0.2.0         stringi_1.4.3         RSQLite_2.1.2        
## [58] highr_0.8             e1071_1.7-2           learnrbook_0.0.2.9001
## [61] rlang_0.4.0           pkgconfig_2.0.3       systemfonts_0.1.1    
## [64] evaluate_0.14         lattice_0.20-38       sf_0.8-0             
## [67] labeling_0.3          bit_1.1-14            tidyselect_0.2.5     
## [70] plyr_1.8.4            magrittr_1.5          wrapr_1.9.0          
## [73] R6_2.4.0              magick_2.2            generics_0.0.2       
## [76] DBI_1.0.0             pillar_1.4.2          haven_2.1.1          
## [79] foreign_0.8-71        withr_2.1.2           units_0.6-4          
## [82] tibble_2.1.3          modelr_0.1.5          crayon_1.3.4         
## [85] KernSmooth_2.23-15    utf8_1.1.4            grid_3.6.1           
## [88] readxl_1.3.1          qpdf_1.1              blob_1.2.0           
## [91] digest_0.6.21         classInt_0.4-1        tidyr_1.0.0          
