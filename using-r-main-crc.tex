...
In this chapter you will learn how to import, manipulate and export data. You will learn about base \Rlang functions and those provided by contributed packages. Some of these packages implement operators that allow chaining operations into ``pipes'' reminiscent of those typical of Unix shells. I focus more on the available tools and how to use them than on their role in the analysis of data. The books \citetitle{Wickham2017} \autocite{Wickham2017} and \citetitle{Peng2016} \autocite{Peng2016} cover partly the same subjects from the perspective of data analysis.
...
## [1] bindrcpp_0.2.2 xlsxjars_0.6.1 rJava_0.9-10   svglite_1.2.1 
## [5] knitr_1.20    
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_0.12.17     cellranger_1.1.0 pillar_1.2.3     compiler_3.5.0  
##  [5] highr_0.6        bindr_0.1.1      forcats_0.3.0    pdftools_1.8    
##  [9] ncdf4_1.16       lubridate_1.7.4  jsonlite_1.5     evaluate_0.10.1 
## [13] tibble_1.4.2     RNetCDF_1.9-1    pkgconfig_2.0.1  rlang_0.2.1     
## [17] cli_1.0.0        curl_3.2         haven_1.1.1      dplyr_0.7.5     
## [21] stringr_1.3.1    xml2_1.2.0       gdtools_0.1.7    hms_0.4.2       
## [25] tidyselect_0.2.4 glue_1.2.0       R6_2.2.2         readxl_1.1.0    
## [29] foreign_0.8-70   tidyr_0.8.1      readr_1.1.1      purrr_0.2.5     
## [33] magrittr_1.5     assertthat_0.2.0 utf8_1.1.4       xlsx_0.5.7      
## [37] stringi_1.2.2    learnrbook_0.0.2 crayon_1.3.4
\end{verbatim}
\end{kframe}
\end{knitrout}
