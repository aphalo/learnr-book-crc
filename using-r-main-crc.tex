...
##  [6] "theme"       "coordinates" "facet"       "plot_env"    "labels"
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{explainbox}
...
{\centering \includegraphics[width=.7\textwidth]{figure/pos-ggplot-basics-12d-1} 
...
{\centering \includegraphics[width=.7\textwidth]{figure/pos-ggplot-basics-13-1} 
...
\hlkwd{ggplot}\hlstd{(my.col.data,}
       \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= treatment,} \hlkwc{y} \hlstd{= measurement,} \hlkwc{fill} \hlstd{= group))} \hlopt{+}
  \hlkwd{geom_col}\hlstd{(}\hlkwc{width} \hlstd{=} \hlnum{0.5}\hlstd{)}
\end{alltt}
\end{kframe}
...
\hlkwd{ggplot}\hlstd{(my.col.data,}
       \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= treatment,} \hlkwc{y} \hlstd{= measurement,} \hlkwc{fill} \hlstd{= group))} \hlopt{+}
  \hlkwd{geom_col}\hlstd{(}\hlkwc{position} \hlstd{=} \hlstr{"dodge"}\hlstd{)}
\end{alltt}
\end{kframe}
...
{\centering \includegraphics[width=.7\textwidth]{figure/pos-text-plot-02-1} 
...
\hlstd{p1} \hlkwb{<-}
  ...
  \hlkwd{geom_point}\hlstd{(}\hlkwc{shape} \hlstd{=} \hlstr{"circle filled"}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\begin{alltt}
\hlstd{p1} \hlopt{+}
  \hlkwd{stat_summary}\hlstd{(}\hlkwc{fun} \hlstd{=} \hlstr{"mean"}\hlstd{,} \hlkwc{geom} \hlstd{=} \hlstr{"point"}\hlstd{,} \hlkwc{color} \hlstd{=} \hlstr{"red"}\hlstd{,} \hlkwc{shape} \hlstd{=} \hlstr{"-"}\hlstd{,} \hlkwc{size} \hlstd{=} \hlnum{10}\hlstd{)}
\end{alltt}
\end{kframe}
...
\begin{alltt}
\hlstd{p1} \hlopt{+}
  \hlkwd{stat_summary}\hlstd{(}\hlkwc{fun.data} \hlstd{=} \hlstr{"mean_cl_boot"}\hlstd{,} \hlkwc{fun.args} \hlstd{=} \hlkwd{list}\hlstd{(}\hlkwc{conf.int} \hlstd{=} \hlnum{0.90}\hlstd{),}
...
\begin{alltt}
\hlstd{p1} \hlopt{+}
  \hlkwd{stat_summary}\hlstd{(}\hlkwc{fun.data} \hlstd{=} \hlstr{"mean_se"}\hlstd{,} \hlkwc{color} \hlstd{=} \hlstr{"red"}\hlstd{,} \hlkwc{size} \hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{alpha} \hlstd{=} \hlnum{0.7}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\begin{alltt}
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= fake.data,} \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{y} \hlstd{= y,} \hlkwc{x} \hlstd{= group))} \hlopt{+}
  \hlkwd{stat_summary}\hlstd{(}\hlkwc{fun} \hlstd{=} \hlstr{"mean"}\hlstd{,} \hlkwc{geom} \hlstd{=} \hlstr{"point"}\hlstd{,} \hlkwc{fill} \hlstd{=} \hlstr{"white"}\hlstd{,} \hlkwc{color} \hlstd{=} \hlstr{"black"}\hlstd{)} \hlopt{+}
  \hlkwd{stat_summary}\hlstd{(}\hlkwc{fun.data} \hlstd{=} \hlstr{"mean_cl_boot"}\hlstd{,} \hlkwc{geom} \hlstd{=} \hlstr{"errorbar"}\hlstd{,}
...
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= my.data,}
  ...
  \hlkwd{stat_bin2d}\hlstd{(}\hlkwc{bins} \hlstd{=} \hlnum{8}\hlstd{)}
\end{alltt}
\end{kframe}
...
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= my.data,}
       \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= X,} \hlkwc{y} \hlstd{= Y))} \hlopt{+}
  \hlkwd{stat_bin_hex}\hlstd{(}\hlkwc{bins} \hlstd{=} \hlnum{8}\hlstd{)}
\end{alltt}
\end{kframe}
...
\begin{alltt}
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= my.data,}
       \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= Y,} \hlkwc{color} \hlstd{= group))} \hlopt{+}
...
\begin{alltt}
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= my.data,}
       \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= group,} \hlkwc{y} \hlstd{= Y))} \hlopt{+}
...
\definecolor{shadecolor}{rgb}{0.984, 0.984, 0.984}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= my.data,} \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= group,} \hlkwc{y} \hlstd{= Y))} \hlopt{+}
...
\begin{alltt}
\hlkwd{ggplot}\hlstd{(}\hlkwc{data} \hlstd{= my.data,}
       \hlkwc{mapping} \hlstd{=} \hlkwd{aes}\hlstd{(}\hlkwc{x} \hlstd{= group,} \hlkwc{y} \hlstd{= Y,} \hlkwc{fill} \hlstd{= group))} \hlopt{+}
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-scatter-13a-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-scatter-13b-1} 
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 7199 rows containing missing values or values outside the scale range\\\#\# (`geom\_line()`).}}\end{kframe}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 9359 rows containing missing values or values outside the scale range\\\#\# (`geom\_line()`).}}\end{kframe}
