...
Margins display an additional column or row of panels with the combines data.
\begin{knitrout}\footnotesize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{p} \hlopt{+} \hlkwd{facet_grid}\hlstd{(}\hlkwc{cols} \hlstd{=} \hlkwd{vars}\hlstd{(vs, am))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-26-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-38-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-39-1} 
...
{\centering \includegraphics[width=.54\textwidth]{figure/pos-main-chunk-43-1} 
\includegraphics[width=.54\textwidth]{figure/pos-main-chunk-43-2} 
...
\includegraphics[width=.54\textwidth]{figure/pos-main-chunk-49-2} 
\includegraphics[width=.54\textwidth]{figure/pos-main-chunk-49-3} 
