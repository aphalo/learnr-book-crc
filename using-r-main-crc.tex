...
Function \Rfunction{gather()} converts data from wide form into long form (or ''tidy''). We use as an example the \Rdata{iris} data set included in base \Rlang. We use \code{gather} to obtain a long-form tibble. By comparing \code{iris} with \code{long\_iris} we can appreciate how \Rfunction{gather()} reshaped its input.
\begin{knitrout}\footnotesize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\end{verbatim}
\begin{alltt}
\hlstd{long_iris} \hlkwb{<-} \hlkwd{gather}\hlstd{(iris,} \hlkwc{key} \hlstd{= part,} \hlkwc{value} \hlstd{= dimension,} \hlopt{-}\hlstd{Species)}
\hlkwd{head}\hlstd{(long_iris)}
\end{alltt}
\begin{verbatim}
...
\begin{warningbox}
However, altering the normal interpretation of the name passed as argument to \code{key} and \code{value} prevents there arguments to be recognised as the name of variable. We need to use a new operator \code{!!} to restore the normal \Rlang behaviour.
\begin{knitrout}\footnotesize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{part} \hlkwb{<-} \hlstr{"not part"}
\hlstd{long_iris} \hlkwb{<-} \hlkwd{gather}\hlstd{(iris,} \hlkwc{key} \hlstd{=} \hlopt{!!}\hlstd{part,} \hlkwc{value} \hlstd{= dimension,} \hlopt{-}\hlstd{Species)}
\hlkwd{head}\hlstd{(long_iris)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{select}\hlstd{(iris,} \hlopt{-}\hlkwd{starts_with}\hlstd{(}\hlstr{"Sepal"}\hlstd{))}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{select}\hlstd{(iris, Species,} \hlkwd{matches}\hlstd{(}\hlstr{"pal"}\hlstd{))}
\end{alltt}
\begin{verbatim}
...
##  [1] Rcpp_1.0.1       pillar_1.4.2     compiler_3.6.0   cellranger_1.1.0
##  [5] highr_0.8        forcats_0.4.0    pdftools_2.2     zeallot_0.1.0   
##  [9] ncdf4_1.16.1     jsonlite_1.6     lubridate_1.7.4  evaluate_0.14   
...
## [25] gdtools_0.1.9    vctrs_0.2.0      xlsxjars_0.6.1   askpass_1.1     
## [29] hms_0.5.0        tidyselect_0.2.5 glue_1.3.1       qpdf_1.1        
## [33] R6_2.4.0         fansi_0.4.0      readxl_1.3.1     foreign_0.8-71  
## [37] tidyr_0.8.3      wrapr_1.8.8      readr_1.3.1      purrr_0.3.2     
## [41] magrittr_1.5     ellipsis_0.2.0.1 backports_1.1.4  assertthat_0.2.1
## [45] utf8_1.1.4       xlsx_0.6.1       stringi_1.4.3    learnrbook_0.0.2
## [49] crayon_1.3.4
\end{verbatim}
\end{kframe}
\end{knitrout}
