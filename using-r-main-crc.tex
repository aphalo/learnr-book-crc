...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{a.df} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{treatment} \hlstd{=} \hlkwd{factor}\hlstd{(}\hlkwd{rep}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"hot"}\hlstd{,} \hlstr{"cold"}\hlstd{),} \hlnum{3}\hlstd{)),}
...
\end{verbatim}
\begin{alltt}
\hlkwd{colnames}\hlstd{(a.df)}
\end{alltt}
\begin{verbatim}
## [1] "treatment" "height"    "weight"
\end{verbatim}
\begin{alltt}
\hlkwd{rownames}\hlstd{(a.df)}
\end{alltt}
\begin{verbatim}
## [1] "1" "2" "3" "4" "5" "6"
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{a.df}\hlopt{$}\hlstd{height}
\end{alltt}
\begin{verbatim}
## [1] 10.2  8.3 12.0  9.0 11.2  8.7
\end{verbatim}
\begin{alltt}
\hlstd{a.df[[}\hlstr{"height"}\hlstd{]]}
\end{alltt}
\begin{verbatim}
## [1] 10.2  8.3 12.0  9.0 11.2  8.7
\end{verbatim}
\begin{alltt}
\hlstd{a.df[[}\hlnum{2}\hlstd{]]}
\end{alltt}
\begin{verbatim}
## [1] 10.2  8.3 12.0  9.0 11.2  8.7
\end{verbatim}
\begin{alltt}
\hlkwd{class}\hlstd{(a.df[[}\hlstr{"height"}\hlstd{]])}
\end{alltt}
\begin{verbatim}
## [1] "numeric"
\end{verbatim}
...
\hlstd{a.df[[}\hlstr{"x3"}\hlstd{]]} \hlkwb{<-} \hlstr{"b"}
\hlkwd{str}\hlstd{(a.df)}
\end{alltt}
\begin{verbatim}
...
\hlstd{a.df[ ,} \hlstr{"treatment"}\hlstd{]}
\end{alltt}
\begin{verbatim}
## [1] hot  cold hot  cold hot  cold
## Levels: cold hot
...
\hlstd{a.df[a.df}\hlopt{$}\hlstd{treatment} \hlopt{==} \hlstr{"hot"} \hlstd{, ]}
\end{alltt}
\begin{verbatim}
##   treatment height weight x2 x3
## 1       hot   10.2    2.2  6  b
...
\begin{alltt}
\hlcom{# the heights > 8}
\hlstd{a.df[a.df}\hlopt{$}\hlstd{height} \hlopt{>} \hlnum{8}\hlstd{,} \hlstr{"height"}\hlstd{]}
\end{alltt}
\begin{verbatim}
## [1] 10.2  8.3 12.0  9.0 11.2  8.7
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{a.df[}\hlnum{1}\hlstd{,} \hlnum{2}\hlstd{]} \hlkwb{<-} \hlnum{99}
\hlstd{a.df}
\end{alltt}
\begin{verbatim}
##   treatment height weight x2 x3
...
\end{verbatim}
\begin{alltt}
\hlstd{a.df[ ,} \hlnum{2}\hlstd{]} \hlkwb{<-} \hlopt{-}\hlnum{99}
\hlstd{a.df}
\end{alltt}
\begin{verbatim}
##   treatment height weight x2 x3
...
\end{verbatim}
\begin{alltt}
\hlstd{a.df[[}\hlstr{"height"}\hlstd{]]} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{10}\hlstd{,} \hlnum{12}\hlstd{)}
\hlstd{a.df}
\end{alltt}
\begin{verbatim}
##   treatment height weight x2 x3
...
\end{verbatim}
\begin{alltt}
\hlstd{a.df[}\hlnum{1}\hlstd{,} \hlnum{2}\hlstd{]} \hlkwb{<-} \hlstd{a.df[}\hlnum{6}\hlstd{,} \hlnum{3}\hlstd{]}
\hlstd{a.df}
\end{alltt}
\begin{verbatim}
##   treatment height weight x2 x3
...
\end{verbatim}
\begin{alltt}
\hlstd{a.df[}\hlnum{3}\hlopt{:}\hlnum{6}\hlstd{,} \hlnum{2}\hlstd{]} \hlkwb{<-} \hlstd{a.df[}\hlnum{6}\hlstd{,} \hlnum{3}\hlstd{]}
\hlstd{a.df}
\end{alltt}
\begin{verbatim}
##   treatment height weight x2 x3
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{is.data.frame}\hlstd{(a.df[}\hlnum{1}\hlstd{, ])}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
\begin{alltt}
\hlkwd{is.data.frame}\hlstd{(a.df[ ,} \hlnum{2}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] FALSE
\end{verbatim}
\begin{alltt}
\hlkwd{is.data.frame}\hlstd{(a.df[ ,} \hlstr{"treatment"}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] FALSE
\end{verbatim}
\begin{alltt}
\hlkwd{is.data.frame}\hlstd{(a.df[}\hlnum{1}\hlopt{:}\hlnum{2}\hlstd{,} \hlnum{2}\hlopt{:}\hlnum{3}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
\begin{alltt}
\hlkwd{is.vector}\hlstd{(a.df[}\hlnum{1}\hlstd{, ])}
\end{alltt}
\begin{verbatim}
## [1] FALSE
\end{verbatim}
\begin{alltt}
\hlkwd{is.vector}\hlstd{(a.df[ ,} \hlnum{2}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
\begin{alltt}
\hlkwd{is.factor}\hlstd{(a.df[ ,} \hlstr{"treatment"}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
\begin{alltt}
\hlkwd{is.vector}\hlstd{(a.df[}\hlnum{1}\hlopt{:}\hlnum{2}\hlstd{,} \hlnum{2}\hlopt{:}\hlnum{3}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] FALSE
\end{verbatim}
\begin{alltt}
\hlkwd{is.data.frame}\hlstd{(a.df[ ,} \hlnum{1}\hlstd{,} \hlkwc{drop} \hlstd{=} \hlnum{FALSE}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
\begin{alltt}
\hlkwd{is.data.frame}\hlstd{(a.df[ ,} \hlstr{"treatment"}\hlstd{,} \hlkwc{drop} \hlstd{=} \hlnum{FALSE}\hlstd{])}
\end{alltt}
\begin{verbatim}
## [1] TRUE
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{M} \hlkwb{<-} \hlkwd{matrix}\hlstd{(}\hlnum{1}\hlopt{:}\hlnum{10}\hlstd{,} \hlkwc{ncol} \hlstd{=} \hlnum{2}\hlstd{)}
\hlstd{M}
\end{alltt}
\begin{verbatim}
##      [,1] [,2]
...
\end{verbatim}
\begin{alltt}
\hlkwd{attr}\hlstd{(M,} \hlstr{"dim"}\hlstd{)}
\end{alltt}
\begin{verbatim}
## [1] 5 2
\end{verbatim}
\begin{alltt}
\hlkwd{attr}\hlstd{(M,} \hlstr{"dim"}\hlstd{)} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlnum{2}\hlstd{,} \hlnum{5}\hlstd{)}
\hlstd{M}
\end{alltt}
\begin{verbatim}
##      [,1] [,2] [,3] [,4] [,5]
