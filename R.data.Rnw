...
<<pdftools-01>>=
my.info <- pdf_info("extdata/acp-17-1791-2017.pdf")
my.info[c("created", "pages")]
@

We next extract the text. The returned value is a character vector, with one element per page.

<<pdftools-02>>=
my.text <- pdf_text("extdata/acp-17-1791-2017.pdf")
class(my.text)
length(my.text)
@
...
<<pdftools-03>>=
stringr::str_length(my.text)
stringr::word(my.text[2])
@

\subsubsection[tabulizer]{\pkgname{tabulizer}}

<<tabulizer-01>>=
my.meta <- extract_metadata("extdata/acp-17-1791-2017.pdf")
names(my.meta)
my.meta[c("created", "pages")]
@

<<tabulizer-02>>=
my.text <- extract_text("extdata/acp-17-1791-2017.pdf", page = 2L)
class(my.text)
length(my.text)
@
